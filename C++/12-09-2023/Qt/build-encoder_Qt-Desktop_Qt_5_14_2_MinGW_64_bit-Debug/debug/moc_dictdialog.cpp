...
#include <memory>
#include "../../encoder_Qt/dictdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DictDialog_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "DictDialog\0on_pushButton_clicked\0"
};
...
void DictDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DictDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DictDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_DictDialog.data,
    qt_meta_data_DictDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DictDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DictDialog.stringdata0))
